...
<template>
  <section id="programs" ref="sectionRef" class="relative py-28 md:py-36 overflow-hidden bg-navy-50/30">
    <div class="relative max-w-6xl mx-auto px-6 md:px-12">
      ...
      <!-- CTA below the cards — primary entry to the student-account signup
           (/register). The parent reads the program cards, sees prices, then
           has a clear next step without leaving the section to find it. -->
      <div
