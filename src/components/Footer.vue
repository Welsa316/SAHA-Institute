    ...
    <div class="relative max-w-6xl mx-auto px-6 md:px-12">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <a href="#" aria-label="Facebook" class="w-11 h-11 rounded-full bg-white/[0.05] border border-white/[0.08] flex items-center justify-center text-navy-400 hover:text-white hover:border-white/20 transition-all duration-300">
